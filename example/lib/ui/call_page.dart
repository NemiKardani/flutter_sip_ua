...
class _CallPageState extends ConsumerState<CallPage>
  ...
  Future<void> _performAttendedTransferBetween(
    SipCall source,
    SipCall target,
  ) async {
    if (!source.held) {
  ...
  void _showAttendedTransferSelectSheet(
    SipCall source,
    List<SipCall> otherCalls,
  ) {
                  ...
                  children: [
                      ...
                      _MultiCallTray(
                        ...
                        onAttendedTransfer: (sourceCall) {
                          ...
                          if (otherCalls.isEmpty) {
                            ...
                            _showAttendedTransferSelectSheet(
                              sourceCall,
                              otherCalls,
                            );
                          }
                    ...
                    if (sourceCall != null && state == CallState.active) ...[
                      ...
                      _TransferStatusCard(
                        ...
                        subtitle:
                            'Consulting with ${c.remoteParty} to transfer ${sourceCall.remoteParty} here.',
                        buttonLabel: 'Complete Attended Transfer',
                        onPressed: c.transferPending
                            ? null
                            : _completeAttendedTransfer,
                      ),
                    ] else if (consultationCall != null &&
                        state == CallState.active) ...[
                      const SizedBox(height: 14),
                      _TransferStatusCard(
                        title: 'Attended Transfer Active',
                        subtitle:
                            'Currently consulting with ${consultationCall.remoteParty}. Tap below to complete.',
                        buttonLabel: 'Complete Attended Transfer',
                        onPressed: c.transferPending
                            ? null
                            : _completeAttendedTransfer,
              ...
              Row(
                ...
                children: [
                  IconButton.filled(
                    ...
                    onPressed: call.state == CallState.active
                        ? onAttendedTransfer
                        : null,
                  ),
                  const SizedBox(width: 8),
                  if (call.state == CallState.incomingRinging) ...[
                    ...
                    IconButton.filled(
                      ...
                      icon: Icon(
                        call.held ? Icons.play_arrow : Icons.pause,
                        size: 16,
                        color: Colors.white,
                      ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.swap_calls, color: scheme.primary, size: 28),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
